...
public class UpdateSellerCommand : Notifiable<Notification>, ICommand
{
	public UpdateSellerCommand(string firstName, string lastName, string cep, string street, string neighborhood, string city, string number, string? complement, string email, string numberPhone)
	{
		FirstName = firstName;
		LastName = lastName;
		Cep = cep;
	...
	{
		AddNotifications(new Contract<UpdateSellerCommand>()
			.Requires()
